...
// Language names:
$config['langNames'] = array('ar'=>'ط¹ط±ط¨ظٹ','bg'=>'ذ‘رٹذ»ذ³ذ°ر€رپذ؛ذ¸','bp'=>'Portuguأھs (Brasil)','ca'=>'Catalأ ','cz'=>'ؤŒesky','de'=>'Deutsch','el'=>'خ•خ»خ»خ·خ½خ¹خ؛خ±','en'=>'English','es'=>'Espaأ±ol','fi'=>'Suomi','fr'=>'Franأ§ais','he'=>'×¢×‘×¨×™×ھ','hr' => 'Hrvatski','in'=>'Bahasa Indonesia','it'=>'Italiano','ja'=>'و—¥وœ¬èھ‍','kr'=>'ي•œê¸€','nl'=>'Nederlands','no'=>'Norsk','pl'=>'Polski','ro'=>'Romأ¢nia','ru'=>'ذ رƒرپرپذ؛ذ¸ذ¹','sk'=>'Slovenؤچina','sl'=>'Slovensko','sr'=>'Srpski','sv'=>'Svenska','tr'=>'Tأ¼rkأ§e','uk'=>'ذ£ذ؛ر€ذ°ر—ذ½رپرŒذ؛ذ°','zh'=>'ن¸­و–‡ (ç®€ن½“)', 'zh-tw'=>'ن¸­و–‡ (ç¹پé«”)');
...
$config['inactiveTimeout'] = 160;
// Interval in minutes to check for inactive users:
$config['inactiveCheckInterval'] = 30;
