		...
		if (!$member['is_guest'])
		{
			echo '
								<span class="contact_info floatright">
									...
									', isset($context['disabled_fields']['icq']) ? '' : $member['icq']['link'] , ' ', isset($context['disabled_fields']['msn']) ? '' : $member['msn']['link'], ' ', isset($context['disabled_fields']['yim']) ? '' : $member['yim']['link'], '  ', isset($context['disabled_fields']['aim']) ? '' : $member['aim']['link'], ' ', $member['facebook']['link'], ' ', $member['myspace']['link'], ' ', $member['twitter']['link'], ' ', $member['googleplus']['link'], ' ', $member['youtube']['link'], ' ', $member['deviantart']['link'], '
								</span>';
		}
