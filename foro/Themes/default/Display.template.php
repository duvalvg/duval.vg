...
function template_main()
{
	...
	while ($message = $context['get_message']())
	{
		...
		echo '
				<div', $gpbp_action == 'hide' ? ' id="gpbp_hidden_' . $message['id'] . '"' : '' ,' class="', $message['approved'] ? ($gpbp_action == 'hide' ? 'gpbp_hider ' : '') . ($gpbp_badPost && $gpbp_action != 'none' ? 'gpbp_greyed' : ($message['alternate'] == 0 ? 'windowbg' : 'windowbg2')) : 'approvebg', '">
					<span class="topslice"><span></span></span>
...
// DANIEL BENMERGUI: para que no muestre la cantidad de mensajes al costado de los posts
...
//								<li class="postcount">', $txt['member_postcount'], ': ', $message['member']['posts'], '</li>';
		...
		echo '
								<div class="inner" id="msg_', $message['id'], '"', '>', $gpbp_badPost && !$context['reveal_bad_post'] ? '' : $message['body'], '</div>
							</div>';
