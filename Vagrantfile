...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision :shell, :path => "provisioning/hosts.sh"
  ...
  config.vm.provision :shell, :path => "provisioning/db.sh"
  config.vm.provision :shell, :path => "provisioning/apache.sh"
  config.vm.provision :shell, :path => "provisioning/settings.sh"
